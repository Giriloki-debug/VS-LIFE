...
function Card({ cardData }) {
  const [selectedImage, setSelectedImage] = useState(cardData[0].img);
  const [selectedColor, setSelectedColor] = useState(cardData[0].color);
    ...
    <div className="w-[380px] mx-auto">
      <div className="rounded-md p-2 dark:bg-white bg-gray-100">
        <img
          ...
          width={1000}
          height={1000}
          className="h-80 object-cover w-[500px] rounded-md transition-all duration-300"
          style={{
...
function CardCollection() {
  ...
  return (
    <div className="grid grid-cols-1 tablet:grid-cols-2 laptop:grid-cols-3 gap-4">
      {cardCollections.map((cardData, index) => (
