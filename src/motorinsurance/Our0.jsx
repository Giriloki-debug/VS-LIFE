export default function Our() {
  ...
  const motorInsuranceBenefits = [
    "Provides financial protection for your vehicle in case of accidents or damage.",
    "Covers third-party liabilities, protecting you from legal and financial obligations.",
    "Offers coverage for theft, fire, and natural disasters that could damage your vehicle.",
    "Helps in covering repair costs, reducing your out-of-pocket expenses after an incident.",
    "Some policies offer roadside assistance, providing support in case of breakdowns or emergencies."
  ];
    ...
    <div className="text-justify w-full flex flex-col laptop:flex-row laptop:items-start gap-[40px] py-[30px] px-[30px]">
      <div className="flex flex-col gap-[30px] min-w-[300px] max-w-[800px]">
        <div className="flex gap-[20px]">
          <h1>Benefits of Motor Insurance Plans</h1>
        </div>
  
        {motorInsuranceBenefits.map((benefits) => (
