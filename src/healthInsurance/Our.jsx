export default function Our() {
  ...
  const lifeInsuranceBenefits = [
    "Provides financial security for your family by ensuring they have funds to meet expenses after the policyholder's death.",
    "Offers peace of mind knowing your loved ones will be taken care of in case of unexpected events or emergencies.",
    "Can be used as an investment tool, allowing policyholders to build wealth through savings or returns over time.",
    "Covers long-term financial obligations such as loans, mortgages, or education costs, reducing the burden on dependents.",
    "Some policies offer tax benefits, reducing your taxable income and helping you save more while securing your future."
  ];
      ...
      <div className="text-justify w-full flex flex-col laptop:flex-row laptop:items-start gap-[40px] py-[30px] px-[30px] ">
        <div className="flex flex-col gap-[30px] min-w-[300px] max-w-[800px]">
          <div className="flex  gap-[20px] ">
            <h1 >Benefits of Health Insurance Plans</h1>
          </div>
  
          {lifeInsuranceBenefits.map((benefits) => (
            <li className="flex items-center justify-center gap-[20px]">
              <svg
              ...
              <p className=" font-ubuntu text-lg text-[#454d5d]">
               {benefits}
              </p>
            </li>
          ))}
